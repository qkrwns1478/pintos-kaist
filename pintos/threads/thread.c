					...
					thread_func *function, void *aux)
{
	...
	/* If this thread has a higher priority than the running thread,
	   preempt it. */
	thread_preempt();
...
/* Returns the next thread to be scheduled, or idle_thread if
...
// 	  struct thread *max = list_entry(list_max(&thread_current()->donation_list, thread_priority_greater, NULL), struct thread, donation_elem);
